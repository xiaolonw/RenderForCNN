...
# PATHS
# ------------------------------------------------------------
g_blender_executable_path = '/home/rgirdhar/Software/visualization/blender/blender-2.76-rc3-linux-glibc211-x86_64/blender' #!! MODIFY if necessary
g_matlab_executable_path = '/opt/matlab/8.1/bin/matlab' # !! MODIFY if necessary
